...
```
## В этой домашней работе требовалось в программе-клиенте сгенгерировать массив случайных чисел, с через буффер внести этот массив в разделяемую память, затем, в программе-сервере считать данные из разделяемой памяти, вывести их на экран и отключиться от сервера.
